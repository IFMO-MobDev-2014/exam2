...
public class MyProvider extends ContentProvider {
    ...
    public static final Uri PHOTOS_CONTENT_URI = Uri.parse("content://"
            + AUTHORITY + "/" + DBHelper.TRACKS_TABLE);
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORITY, DBHelper.TRACKS_TABLE, URI_PHOTOS);
        uriMatcher.addURI(AUTHORITY, DBHelper.TRACKS_TABLE + "/#", URI_PHOTOS_ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            case URI_PHOTOS:
                ...
                builder.setTables(DBHelper.TRACKS_TABLE);
                break;
            case URI_PHOTOS_ID:
